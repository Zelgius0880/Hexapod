...
#ifndef VIEWER_ANDROID_SRC_MAIN_JNI_VIEWER_APP_H_
#define VIEWER_ANDROID_SRC_MAIN_JNI_VIEWER_APP_H_
 ...
 */
    ...
    public:
         ...
         */
        ViewerApp(JavaVM *vm, jobject obj, jobject asset_mgr_obj);
         ...
         */
        void OnDrawFrame(jbyte *left, jbyte *right);
        ...
        GLuint *GetTextureHandlers() { return textures_; }
    ...
    private:
        ...
        GLuint textures_[2];            // distortion texture
