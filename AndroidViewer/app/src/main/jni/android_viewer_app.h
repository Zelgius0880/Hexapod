...
#ifndef ANDROID_VIEWER_ANDROID_SRC_MAIN_JNI_ANDROID_VIEWER_APP_H_
#define ANDROID_VIEWER_ANDROID_SRC_MAIN_JNI_ANDROID_VIEWER_APP_H_
...
class AndroidViewerApp {
 public:
   ...
   */
  AndroidViewerApp(JavaVM* vm, jobject obj, jobject asset_mgr_obj);
